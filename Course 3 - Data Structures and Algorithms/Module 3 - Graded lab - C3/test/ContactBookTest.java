...
class ContactBookTest {
    ...
    public void testAddContact() {
        ...
        assertEquals(currentNumOfContacts + 1, testContactBook.getNumberOfContacts());
    ...
    public void testSearchContactByPhone() {
         ...
         **/
        Contact testContact = new Contact("Toni","184048");
        ContactBook testContactBook = new ContactBook();
        testContactBook.addContact(testContact);
        Contact result = testContactBook.searchContactByPhone("184048");
        assertNotNull(result);
        assertEquals(testContact.getName(), result.getName());
        assertEquals(testContact.getPhoneNumber(), result.getPhoneNumber());
