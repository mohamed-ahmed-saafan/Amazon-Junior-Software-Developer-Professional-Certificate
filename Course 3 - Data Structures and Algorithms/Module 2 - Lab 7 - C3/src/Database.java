    ...
    public void mergeSort() {
        ...
        /* TODO 7: Stop the for loop when all sub arrays have been
            ...
            for(int leftStart = 0;leftStart < n;leftStart += 2 * size) {
                /* TODO 8: With each iteration, determine the start and end indexes for the left and right subarrays.*/
                int leftEnd= Math.min(leftStart + size, n);
    ...
    private void merge(int mergeIndex, ArrayList leftArray, ArrayList rightArray) {
        ...
        while (leftIndex < leftArray.size() &&
            ...
            Registration leftVal =
                    (Registration) leftArray.get(leftIndex);
            Registration rightVal =
                    (Registration) rightArray.get(rightIndex);
        ...
        // TODO 23–26: copy remaining left elements
        while (leftIndex < leftArray.size()) {
            registrations.set(mergeIndex++,
                    (Registration) leftArray.get(leftIndex++));
        }
