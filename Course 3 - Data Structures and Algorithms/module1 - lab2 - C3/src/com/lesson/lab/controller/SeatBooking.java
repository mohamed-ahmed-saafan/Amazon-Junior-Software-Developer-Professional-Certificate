...
public class SeatBooking {
    ...
    private ArrayList<Seat> bookedSeatsList = new ArrayList<>();
    // Constructor
    public SeatBooking() {
    ...
    public void addNewBooking(String seatNumber) {
        // TODO 2: check if the seat1 is already booked and not canceled
        // TODO 3 create a new Seat object for the booking,
        // mark the seat1 as booked,
        // set the current date as the booking date
        // TODO 4: add the new seat1 to the bookedSeatsList
        // TODO 5: confirm the booking to the user
        for (Seat seat : bookedSeatsList) {
            if(seat.getSeatNumber().equals(seatNumber)) {
                System.out.println("Seat already booked: " + seat.getSeatNumber());
            }
        }
    ...
    public void cancelBooking(String seatNumber) {
        ...
        for (Seat seat : bookedSeatsList) {
            if(seat.getSeatNumber().equals(seatNumber)) {
                ...
                System.out.println("Seat cancelled: " + seat.getSeatNumber());
            }
            else {
                System.out.println("Seat : " + seat.getSeatNumber() + "does not exist");
            }
        }
    }
    ...
    public void updateBooking(String oldSeatNumber, String newSeatNumber) {
        ...
        for (Seat seat : bookedSeatsList) {
            if (seat.getSeatNumber().equals(oldSeatNumber)) {
                ...
                System.out.println("Seat updated from " + oldSeatNumber + " to " + newSeatNumber);
                return;
            }
        }
    ...
    public void displayBookings() {
        ...
        if(bookedSeatsList.isEmpty() || bookedSeatsList ==null) {
