...
public class ListManager {
    ...
    public void findFirstStudent(){
        ...
        Map.Entry<String, Student> entry = studentsMap.firstEntry();
    /* TODO 4: If the first entry exists, get the Student object
        ...
        if (entry != null && entry.getValue()!=null) {
            System.out.println(" 1st Student Info :  "+entry.getValue());
            return;
        }
        /* TODO 7: If the first Entry doesn't exist or the Student is
        null, print an error message. */
        else {
            System.err.println("Error finding first student");
        }
    ...
    public void findLastStudent(){
        ...
        /* TODO 13: If the last Entry doesn't exist or the Student is
            null, print an error message. */
        Map.Entry<String, Student> entry = studentsMap.lastEntry();
        if (entry != null && entry.getValue()!=null) {
            System.out.println(" last Student Info :  "+entry.getValue());
            return;
        }
        else {
            System.err.println("Error finding last student");
        }
    ...
    public void findNextStudent(String searchString){
        ...
        Map.Entry<String, Student> entry = studentsMap.higherEntry(searchString);
        if (entry != null && entry.getValue()!=null) {
           System.out.println("Student found after "+searchString );
            System.out.println(" Student Info :  "+entry);
            return;
        }
        else {
            System.err.println("Error finding next student");
        }
    }
    ...
    public void findPreviousStudent(String searchString) {
        ...
        Map.Entry<String, Student> entry = studentsMap.lowerEntry(searchString);
        if (entry != null && entry.getValue()!=null) {
            System.out.println("Student found before "+searchString );
            System.out.println(" Student Info :  "+entry);
            return;
        }
        else {
            System.err.println("Error finding previous student");
        }
    }
    }