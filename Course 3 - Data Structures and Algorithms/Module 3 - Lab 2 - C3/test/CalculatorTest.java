...
class CalculatorTest {
    ...
    void testAddTwoIntegersMethodExists(){
        //Calculator calculatorTestObject = new Calculator();
        calculatorTestObject.addTowIntegers(2,4);
    }
    @Test
    void testAddTwoIntegersMethodAddsCorrectly(){
        int actualResult = calculatorTestObject.addTowIntegers(2,4);
...
@Test
    ...
    assertThrows(ArithmeticException.class, () -> calculatorTestObject.addTowIntegers(Integer.MAX_VALUE , 1));
}
}