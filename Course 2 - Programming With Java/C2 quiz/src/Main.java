...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            switch (animalChoiceMenu(keyboard)) {
                 ...
                 */
                case 4:
                    System.out.println("saving animals information to files");
                    System.out.println("!! the files are named after each animal !!");
                    ...
                    break;
                case 5:
                    System.out.println("Reading Files content to retrieve the files");
                    readObjectsFromFile();
                    break;
    ...
    public static void writeObjectsToFile(Tiger tiger, Penguin penguin, Dolphin dolphin) {
        // 3.a Tiger → tiger.txt
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("tiger.txt"))) {
            writer.write("=== Tiger Information ===");
            writer.newLine();
            writer.write(tiger.toString());
            System.out.println(" Tiger saved to tiger.txt");
        } catch (IOException e) {
            System.err.println(" Failed to write Tiger: " + e.getMessage());
        }

        // 3.b Penguin → penguin.txt
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("penguin.txt"))) {
            writer.write("=== Penguin Information ===");
            writer.newLine();
            writer.write(penguin.toString());
            System.out.println(" Penguin saved to penguin.txt");
        } catch (IOException e) {
            System.err.println(" Failed to write Penguin: " + e.getMessage());
        }

        // 3.c Dolphin → dolphin.txt
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("dolphin.txt"))) {
            writer.write("=== Dolphin Information ===");
            writer.newLine();
            writer.write(dolphin.toString());
            System.out.println("Dolphin saved to dolphin.txt");
        } catch (IOException e) {
            System.err.println(" Failed to write Dolphin: " + e.getMessage());
        }
    }
    ...
    public static void readObjectsFromFile(){
        try(FileReader read = new FileReader("tiger.txt");
            BufferedReader readObj = new BufferedReader(read)){
            ...
            System.err.println(" Failed to read Tiger: " + e.getMessage());
        }
        try(FileReader read = new FileReader("penguin.txt");
            BufferedReader readObj = new BufferedReader(read)){
            ...
            System.err.println(" Failed to read penguin: " + e.getMessage());
        }
        try(FileReader read = new FileReader("dolphin.txt");
            BufferedReader readObj = new BufferedReader(read)){
            ...
            System.err.println(" Failed to read dolphin: " + e.getMessage());
        }
    }
}
